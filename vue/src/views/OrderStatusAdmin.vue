  ...
  <div class="flex-container" ref="flexContainer">
    ...
    >
      ...
      >
        ...
        <tbody>
          <tr
            v-for="(orderListItem, index) in orderItemList"
...
export default {
  ...
  methods: {
    sendEmail: async function () {
      this.mail_html =
        "The status for your product order, order_id: " +
        this.order_id +
    ...
    searchOrderInfo() {
      OrderInfoDataService.findByOrderId(this.current_order_id)
        .then((response) => {
    ...
    searchOrderData() {
      OrderDataService.findByOrderId(this.current_order_id)
        .then((response) => {
    ...
    updateOrder() {
      OrderInfoDataService.update(this.current_id, this.orderInfoList2[0])
        .then((response) => {
          alert(
